...
export default function LoginForm() {
  ...
  const router = useRouter(); // Instanța routerului pentru navigare
    ...
    const parolaText = useTranslate("Parola", language);
    const autentificareText = useTranslate("Autentificare", language);
    const aiContText = useTranslate("Nu ai un cont încă?", language);
    const inscrieText = useTranslate("Înscrie-te gratuit", language);
