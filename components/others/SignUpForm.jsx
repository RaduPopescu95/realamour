...
const SignUpForm = () => {
  ...
  // TEXT STRINGS TO TRANSLATE
    ...
    const signUpText = useTranslate("Sign Up", language);
    const alreadyHaveAccountText = useTranslate("Ai deja un cont?", language);
    const conectText = useTranslate("Conecteaza-te", language);
    const registerText = useTranslate("Înregistrează-te", language);
    const emailPlaceholder = useTranslate("Email", language);
    const emailAdresaPlaceholder = useTranslate("Adresă email", language);
    const usernamePlaceholder = useTranslate("Nume utilizator", language);
    const passwordPlaceholder = useTranslate("Parolă", language);
    const confirmPasswordPlaceholder = useTranslate("Confirmă Parola", language);
    const phonePlaceholder = useTranslate("Telefon", language);
    const aboutMePlaceholder = useTranslate("Despre mine", language);
    const videoPlaceholder = useTranslate("Adauga video de prezentare", language);
    const pozePlaceholder = useTranslate("Adauga poze", language);
  // TEXT STRINGS TO TRANSLATE
